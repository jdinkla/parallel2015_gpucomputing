...
{
	FunctionCaller fc("opencl_intel.exe");
	...
	fc.add("simple_multi", &simple_test_multi_gpu);
	...
	fc.add("benchmark_single_opencl", &benchmark_heat_single);
